...
export class Data {
    ...
    public static listVideo: Video[] = [
        { title: 'Bad at Picking COLORS? Let\'s fix that',recommanded:true,
            ...
            comments:[
                {text: 'Hey Gary. I liked the initiative you took over the color selection tuts. But I think you could have done a better job in color selection. Any of the artboards just didn\'t look professional, mainly due to bad color selection.',
                    commentedAt:'il y a 5 minutes',likes: 5, dislikes: 0, author: { name: 'Ayush Parashar', image: './assets/users/unnamed1.jpg', subscribers: 3}},
                {text: 'When i use a color palette site like color inspo, i tend to take screenshot of the palette and import it into my canvas. I place at a corner so its not distracting.',
                    commentedAt:'il y a 19 minutes',likes: 2, dislikes: 0, author: { name: 'Grabster ', image: './assets/users/unnamed2.jpg', subscribers: 233}},
                {text: 'would you like to do if react advanced tutorials.',commentedAt:'il y a 18 heures',
                    likes: 0, dislikes: 0, author: { name: 'ulisses', image: './assets/users/unnamed4.jpg', subscribers: 3}}
            ]
        },

        { title: 'Create a Custom SVG Checkbox',new:true,
            description:'Use code \'DESIGNC19\' to get $20 credit on your new Linode account!',
            ...
            comments:[
                {text: 'You actually don\'t need to add javascript to reverse, you can set your transition to be on the unchecked/default version, it will reverse it. Great video though!',
                    commentedAt:'il y a 4 mois (modifié)',likes: 24, dislikes: 0, author: { name: 'Arthur BienSur', image: './assets/users/unnamed3.jpg', subscribers: 1453}},
                {text: 'Hey Gary,U can use prettier extension to indent all those stuff automatically...',
                    commentedAt:'il y a 5 mois',likes: 1, dislikes: 0, author: { name: 'chirayu josh', image: './assets/users/unnamed4.jpg', subscribers: 33}},
                {text: 'When i use a color palette site like color inspo, i tend to take screenshot of the palette and import it into my canvas. I place at a corner so its not distracting.',
                    commentedAt:'il y a 19 minutes',likes: 2, dislikes: 0, author: { name: 'Grabster ', image: './assets/users/unnamed2.jpg', subscribers: 233}},
                {text: 'would you like to do if react advanced tutorials.',commentedAt:'il y a 18 heures',
                    likes: 0, dislikes: 0, author: { name: 'ulisses', image: './assets/users/unnamed4.jpg', subscribers: 3}}
        ...
        { title: 'Angular Crash Course',new:true,recommanded:true,
            ...
            comments:[
                {text: 'Great introduction to Angular.Be blessed!',commentedAt:'il y a 1 an (modifié)',
                    likes: 1, dislikes: 0, author: { name: 'Harman Kibue', image: './assets/users/unnamed5.jpg', subscribers: 11}},
                {text: 'my httpClient methods are different plz help me',commentedAt:'il y a 7 mois',
        ...
        { title: 'This is what happens when you reply to spam email | James Veitch',
            ...
            comments:[
                {text: 'My brother got a text from a scammer so he spoiled endgame for them',
                    commentedAt:'il y a 3 semaines',likes: 35000, dislikes: 0, author: { name: 'Manaphy099', image: './assets/users/unnamed5.jpg', subscribers: 11}},
                {text: 'This dude is the true definition of chaotic good.',
                    commentedAt:'il y a 3 mois',likes: 6400, dislikes: 0, author: { name: 'Honey Bunny', image: './assets/users/unnamed6.jpg', subscribers: 3}}
            ]
        },
        ...
        { title: 'Inside the mind of a master procrastinator | Tim Urban',
            ...
            author:{ name:' TED', image: './assets/users/TED.jpg', subscribers: 15900000},
            comments:[
                {text: 'I feel like my \'Monkey\' is not afraid of monster anymore....',commentedAt:'il y a 3 semaines',
                    likes: 413, dislikes: 0, author: { name: 'Michel Cerny', image: './assets/users/unnamed5.jpg', subscribers: 11}},
                {text: '“Inside the mind of master procrastinator” Me: adds to “watch later”',commentedAt:'il y a une semaine',
        ...
        { title: '10 ways to have a better conversation | Celeste Headlee',
            ...
            author:{ name:' TED', image: './assets/users/TED.jpg', subscribers: 15900000},
            comments:[
                {text: 'Most people don\'t really listen, they\'re just waiting for their turn to speak',commentedAt:'il y a 2 mois',
                    likes: 459, dislikes: 0, author: { name: 'Michael Koro', image: './assets/users/unnamed5.jpg', subscribers: 11}},
                {text: '“Inside the mind of master procrastinator” Me: adds to “watch later”',commentedAt:'il y a 1 mois',
                    likes: 18000, dislikes: 0, author: { name: 'C N', image: './assets/users/unnamed4.jpg', subscribers: 3}}
            ]
        },
        { title: 'Web Development In 2020 - A Practical Guide',
            ...
            author:{ name:'  Traversy Media', image: './assets/users/Trav.jpg', subscribers: 9690000},
            comments:[
                {text: 'I owe my career to this man. Thank you Mr Traversy!',commentedAt:'il ya 5 minutes',
                    likes: 149, dislikes: 0, author: { name: 'Zack Leitzel-Berrie', image: './assets/users/unnamed8.jpg', subscribers: 1111}},
                {text: 'It gets better each and every year. Christmas came early.',commentedAt:'il ya 11 mois',
        ...
        { title: 'Node.js GeoJSON API & App | Store Locator',
            ...
            author:{ name:'  Traversy Media', image: './assets/users/Trav.jpg', subscribers: 9690000},
            comments:[
                {text: 'Happy New Year, Brad! Thank you for everything you did for us in 2019! ',commentedAt:'il y a 5 heures',
